...
struct  ServicePointManager_t1320  : public Object_t
{
};
struct ServicePointManager_t1320_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t1349 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t1332 * ___server_cert_cb_9;
};
