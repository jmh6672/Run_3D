...
struct  ExtendedKeyUsageExtension_t1212  : public X509Extension_t1206
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t1171 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1212_StaticFields{
	...
	Dictionary_2_t736 * ___U3CU3Ef__switchU24map14_4;
};
