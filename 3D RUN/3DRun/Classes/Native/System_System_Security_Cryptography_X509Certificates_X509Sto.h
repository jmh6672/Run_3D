...
struct  X509Store_t1406  : public Object_t
{
	...
	X509Certificate2Collection_t1400 * ___list_2;
	...
	X509Store_t1207 * ___store_4;
};
struct X509Store_t1406_StaticFields{
	...
	Dictionary_2_t736 * ___U3CU3Ef__switchU24mapF_5;
};
